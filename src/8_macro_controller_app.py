...
- 共享同一个宏 JSON 文件（8_macro.json），各自独立加载
...
DEFAULT_MACRO_PATH = os.path.join(_script_dir, "macros", "8_macro.json")
...
class MultiDeviceApp:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("宏控制 V4 - 双设备并行控制")
