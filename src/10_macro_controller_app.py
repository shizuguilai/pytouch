...
DEFAULT_MACRO_PATH = os.path.join(_script_dir, "macros", "10_macro.json")
...
class MultiDeviceApp:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("宏控制 V5 - 双设备并行控制")
