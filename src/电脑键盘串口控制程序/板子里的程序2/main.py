...
atouch = 0b1111111111000000    #所有点击头抬起状态
btouch = 0b1111100000111111    #所有点击头抬起状态
ctouch = 0b000001111111111    #所有点击头抬起状态
...
def func_A():
    ...
    if isRUN:
        ...
        if touchST != 1:
            TOBJ.deinit() 
            touchST = 1
            TOBJ.init(period=300,mode=Timer.ONE_SHOT ,callback=runTimer)
        else:
            touchST = -1
            TOBJ.deinit()
    else:
